...
export default function Dashboard() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center h-full bg-green-100 ">
      ...
      <div className="bg-white  border shadow-xl shadow-green-400 rounded-md m-auto w-[70%] h-vh p-36 text-center justify-center">
        {user && (
          <>
        ...
        {user &&
          ...
          (!userInfo.menu_items ||
            ...
            <>
              <div className="my-6">
                You have not created any menu items yet. Upload a picture of
                your menu to automatically generate mobile ordering and rewards
                points system.
              </div>
              <div>
